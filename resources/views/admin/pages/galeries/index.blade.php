        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">Galeries List</h1>
                </div>
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="<?= url('admin/galeries/create') ?>">
    ...
    @endif
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2">Total Galeries</h6>
                ...
                <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ url('admin/galeries/'.$b->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <a href="{{ url("admin/galeries/".$b->id."/edit") }}" class="btn btn-success btn-sm"><i class="tio-edit"></i> Update</a>
