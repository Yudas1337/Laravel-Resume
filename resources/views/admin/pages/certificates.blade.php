                ...
                <table id="datatable" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
                    ...
                    <tbody>
                       ...
                       <tr>
                           ...
                           <td>
                               <a href="" class="badge badge-soft-success p-2 btn-edit" data-toggle="modal" data-target="#ModalEdit" data-id="<?= $certificate->id ?>" data-title="<?= $certificate->title ?>" data-description="<?= $certificate->description ?>" data-photo="<?= $certificate->photo ?>">
                                        <i class=" tio-edit"></i>
                                        Edit</a>
                                    <a href="" class="badge badge-soft-danger p-2 alertAktivasi sweetalert">
